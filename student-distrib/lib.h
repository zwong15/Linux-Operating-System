...
#define VIDEO2       0xB9000
#define VIDEO3       0xBA000
#define VIDEO4       0xBB000
#define NUM_COLS     80
#define NUM_ROWS     25
#define NUM_ROWS_NEW 23
#define ATTRIB       0x3
#define FIFTEEN      0x0F
#define FOURTEEN     0x0E
#define BUFFSIZE     129
#define INPUTSELECT  0x3D4
#define OUTPUTSELECT 0x3D5
#define SHIFT        8
#define MAXCOUNT     127
...
void clear(void);
//function that deletes the previous char
int backspace(int counter);
//moves the cursor
void cursor(int screen_x, int screen_y);
//function that moves the cursor when char is printed
void move(void);
